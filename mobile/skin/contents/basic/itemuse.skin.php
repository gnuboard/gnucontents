...
<section id="cit_use_list">
    ...
    ?>
        ...
        <li class="cit_use_li">
            ...
            <dl class="cit_use_dl">
                ...
                <dt>평점<dt>
                <dd class="cit_use_star"><img src="<?php echo G5_CONTENTS_URL; ?>/img/s_star<?php echo $is_star; ?>.png" alt="별<?php echo $is_star; ?>개"></dd>
            </dl>
    ...
    if (!$i) echo '<p class="cit_empty">사용후기가 없습니다.</p>';
    ?>
</section>
