...
<div id="sct_win">
    ...
    for($i=0; $row=sql_fetch_array($result); $i++) {
        ...
        $ca_href = G5_CONTENTS_URL.'/category.php?ca='.$row['ca_id'];
        $list_href = G5_CONTENTS_URL.'/list.php?ca_id='.$row['ca_id'];
    ?>
        <li>
    ...
    <div class="win_btn">
        <button onclick="javascript:window.close();" class="close_btn">창닫기</button>
    </div>
