...
// 리스트 유형별로 출력
$list_file = G5_MCONTENTS_SKIN_PATH."/{$ev['ev_mobile_skin']}";
if (file_exists($list_file))
{
    include G5_MCONTENTS_SKIN_PATH.'/list.sort.skin.php';
    ...
    $list = new cm_item_list(G5_MCONTENTS_SKIN_PATH.'/'.$ev['ev_mobile_skin'], $ev['ev_mobile_list_mod'], $ev['ev_mobile_list_row'], $ev['ev_mobile_img_width'], $ev['ev_mobile_img_height']);
