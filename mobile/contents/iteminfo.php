...
$sql = " select a.*,
                b.ca_name,
                b.ca_use
           from {$g5['g5_contents_item_table']} a,
...
$sql = " select ca_mobile_skin_dir, ca_include_head, ca_include_tail, ca_cert_use, ca_adult_use
           from {$g5['g5_contents_category_table']}
...
if ($default['de_mobile_rel_list_use']) {
    ...
    $sql = " select count(*) as cnt
               ...
               left join {$g5['g5_contents_item_table']} b on (a.it_id2=b.it_id and b.it_use='1')
...
?>
    ...
    <button type="button" id="iteminfo_close" onclick="self.close();">창닫기</button>
<?php
}
?>
...
switch($info) {
    case 'use':
        include_once(G5_MCONTENTS_SKIN_PATH.'/iteminfo.itemuse.skin.php');
        break;
    case 'qa':
        include_once(G5_MCONTENTS_SKIN_PATH.'/iteminfo.itemqa.skin.php');
        break;
    case 'rel':
        include_once(G5_MCONTENTS_SKIN_PATH.'/iteminfo.relation.skin.php');
        break;
    default:
        include_once(G5_MCONTENTS_SKIN_PATH.'/iteminfo.info.skin.php');
        break;
}
?>
</div>
