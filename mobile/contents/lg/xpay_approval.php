...
require_once(G5_MCONTENTS_PATH.'/settle_lg.inc.php');
...
$LGD_RETURNURL			    = G5_MCONTENTS_URL.'/lg/returnurl.php';
$LGD_KVPMISPNOTEURL         = G5_MCONTENTS_URL.'/lg/note_url.php';
$LGD_KVPMISPWAPURL		    = G5_MCONTENTS_URL.'/lg/mispwapurl.php?LGD_OID='.$LGD_OID;   //ISP 카드 결제시, URL 대신 앱명 입력시, 앱호출함
$LGD_KVPMISPCANCELURL       = G5_MCONTENTS_URL.'/lg/cancel_url.php';
$LGD_MTRANSFERWAPURL        = G5_MCONTENTS_URL.'/lg/returnurl.php';
$LGD_MTRANSFERCANCELURL     = G5_MCONTENTS_URL.'/lg/cancel_url.php';
$LGD_MTRANSFERNOTEURL       = G5_MCONTENTS_URL.'/lg/note_url.php';
