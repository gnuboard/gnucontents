...
function fsubmit_check(f)
{
    ...
    $.post(
        ...
        function(data) {
            if(data == "Fail") {
                alert("SMS 설정 오류로 문의내용을 전송할 수 없습니다.\n\n사이트 관리자에게 문의해 주십시오.");
