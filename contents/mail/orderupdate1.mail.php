...
<div style="margin:30px auto;width:600px;border:10px solid #f7f7f7">
    <div style="border:1px solid #dedede">
        ...
        <tr>
            ...
            <td style="<?php echo $td_st; ?>"><a href="<?php echo G5_CONTENTS_URL.'/item.php?it_id='.$list[$i]['it_id']; ?>" target="_blank" style="text-decoration:none"><span style="display:inline-block;vertical-align:middle"><?php echo $list[$i]['it_simg']; ?></span> <?php echo $list[$i]['it_name']; ?></a></td>
        </tr>
        <tr>
            <th scope="row" style="<?php echo $th_st; ?>">판매가격</th>
            <td style="<?php echo $td_st; ?>"><?php echo cm_display_price($list[$i]['ct_price']); ?></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td style="<?php echo $td_st; ?>"><?php echo cm_display_price($list[$i]['stotal_price']); ?></td>
        </tr>
        <tr>
            <th scope="row" style="<?php echo $th_st; ?>">포인트</th>
            <td style="<?php echo $td_st; ?>"><?php echo cm_display_point($list[$i]['stotal_point']); ?></td>
        </tr>
        <?php } ?>

        <tr>
            <th scope="row" style="<?php echo $th_st; ?>">주문합계</th>
            <td style="<?php echo $td_st; ?>"><?php echo cm_display_price($ttotal_price); ?></td>
        </tr>
        <tr>
            <th scope="row" style="<?php echo $th_st; ?>">포인트합계</th>
            <td style="<?php echo $td_st; ?>"><?php echo cm_display_point($ttotal_point); ?></td>
        </tr>
        </tbody>
        </table>
        ...
        <tr>
            ...
            <td style="<?php echo $td_st; ?>"><?php echo cm_display_point($od_receipt_point); ?></td>
        </tr>
        <?php } ?>

        <?php if ($od_receipt_cash > 0) { ?>
        <tr>
            <th scope="row" style="<?php echo $th_st; ?>">캐시 입금액</th>
            <td style="<?php echo $td_st; ?>"><?php echo cm_display_price($od_receipt_cash); ?></td>
        </tr>
        <?php } ?>
        ...
        <tr>
            ...
            <td style="<?php echo $td_st; ?>"><?php echo cm_display_price($od_receipt_price); ?></td>
        </tr>
        <?php } ?>
        ...
        <?php if (!($od_receipt_point || $od_receipt_cash || $od_receipt_price)) { ?>
        <tr>
        ...
        <table style="<?php echo $cont_st; ?>">
        <caption style="<?php echo $caption_st; ?>">구매하신 분 정보</caption>
        <colgroup>
            <col style="width:130px">
            <col>
        </colgroup>
        ...
        <a href="<?php echo G5_ADMIN_URL.'/contents_admin/orderform.php?od_id='.$od_id; ?>" target="_blank" style="<?php echo $ft_a_st; ?>">관리자 모드에서 주문 확인</a>
