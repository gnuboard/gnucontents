...
<div style="margin:30px auto;width:600px;border:10px solid #f7f7f7">
    <div style="border:1px solid #dedede">
        ...
        <tr>
            <td style="<?php echo $td_st; ?>"><a href="<?php echo G5_CONTENTS_URL; ?>/item.php?it_id=<?php echo $cart_list[$h]['it_id']; ?>" target="_blank" style="text-decoration:none"><?php echo $cart_list[$h]['it_name']; ?></a></td>
        ...
        <?php if (count($cash_list)) { ?>
        <table style="<?php echo $cont_st; ?>">
        <caption style="<?php echo $caption_st; ?>">캐시 결제 확인</caption>
        <colgroup>
            <col style="width:130px">
            <col>
        </colgroup>
        ...
        <tr>
            <th scope="row" style="<?php echo $th_st; ?>">확인일시</th>
            <td style="<?php echo $td_st; ?>"><?php echo $cash_list['od_time']; ?></td>
        </tr>
        <tr>
            <th scope="row" style="<?php echo $th_st; ?>">캐시</th>
            <td style="<?php echo $td_st; ?>"><?php echo $cash_list['od_receipt_cash']; ?></td>
        </tr>
        </tbody>
        </table>
        <?php } ?>
