 ...
 **************************************************************************************************/
$inipay->SetField("admin",    $setting['de_inicis_admin_key']); // 키패스워드(키발급시 생성, 상점관리자 패스워드와 상관없음)
 ...
 * 6. 세션정보 저장  *
 *********************/
set_session('INI_MID',     $setting['de_inicis_mid']);       //상점ID
set_session('INI_ADMIN',   $setting['de_inicis_admin_key']); // 키패스워드(키발급시 생성, 상점관리자 패스워드와 상관없음)
