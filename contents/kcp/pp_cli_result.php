...
<?php
echo '<link rel="stylesheet" href="'.G5_CSS_URL.'/'.(G5_IS_MOBILE?'mobile':'default').'_contents.css">'.PHP_EOL;
?>
<style>
...
<script>
    ...
    {
        var receiptWin = "<?php echo G5_CM_CASH_RECEIPT_URL.$setting['de_kcp_mid'].'&orderid='.$ordr_idxx.'&bill_yn=Y&authno='; ?>"+auth_no;
