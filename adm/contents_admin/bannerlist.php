...
$sql_common = " from {$g5['g5_contents_banner_table']} ";
...
<div class="tbl_head02 tbl_wrap" id="bannerlist">
    <table>
    ...
    <tbody>
    <?php
    $sql = " select * from {$g5['g5_contents_banner_table']}
    ...
    for ($i=0; $row=mysql_fetch_array($result); $i++) {
        ...
        if(file_exists($bimg)) {
            ...
            $bn_img .= '<img src="'.G5_DATA_URL.'/cmbanner/'.$row['bn_id'].'" width="'.$width.'" alt="'.$row['bn_alt'].'"></a>';
        }
