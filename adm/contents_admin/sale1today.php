...
<div class="tbl_head01 tbl_wrap">
    ...
    <?php
        ...
        $tot['receipt_cash']  += $row['od_receipt_cash'];
    ...
    <tr>
        <td colspan="2">합 계</td>
        <td class="td_r"><?php echo number_format($tot['orderprice']); ?></td>
        <td class="td_r"><?php echo number_format($tot['coupon']); ?></td>
        <td class="td_r"><?php echo number_format($tot['receipt_bank']); ?></td>
        <td class="td_r"><?php echo number_format($tot['receipt_vbank']); ?></td>
        <td class="td_r"><?php echo number_format($tot['receipt_iche']); ?></td>
        <td class="td_r"><?php echo number_format($tot['receipt_card']); ?></td>
        <td class="td_r"><?php echo number_format($tot['receipt_hp']); ?></td>
        <td class="td_r"><?php echo number_format($tot['receipt_cash']); ?></td>
        <td class="td_r"><?php echo number_format($tot['receipt_point']); ?></td>
        <td class="td_r"><?php echo number_format($tot['ordercancel']); ?></td>
        <td class="td_r"><?php echo number_format($tot['misu']); ?></td>
    </tr>
    </tfoot>
    </table>
</div>
