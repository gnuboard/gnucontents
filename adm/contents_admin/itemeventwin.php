...
$sql = " select ev_subject from {$g5['g5_contents_event_table']} where ev_id = '$ev_id' ";
$ev = sql_fetch($sql);
...
<div class="new_win">
    ...
    <div class="tbl_head01 tbl_wrap">
        ...
        <tbody>
        <?php
        $sql = " select b.it_id, b.it_name, b.it_use from {$g5['g5_contents_event_item_table']} a
        ...
        <tr>
            <td>
                <a href="<?php echo $href; ?>" target="_blank">
                    <?php echo cm_get_it_image($row['it_id'], 40, 40); ?>
