...
$sql  = " select a.it_id,
            ...
            from {$g5['g5_contents_wish_table']} a, {$g5['g5_contents_item_table']} b ";
...
<div class="tbl_head01 tbl_wrap">
    ...
    <tr class="<?php echo $bg; ?>">
        ...
        <td>
            <a href="<?php echo $href; ?>"><?php echo cm_get_it_image($row['it_id'], 50, 50); ?> <?php echo cut_str($row['it_name'],30); ?></a>
        </td>
        <td class="td_num td_c"><?php echo $row['it_id_cnt']; ?></td>
    </tr>
    <?php
    }
