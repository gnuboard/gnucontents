...
$sql = " update {$g5['g5_contents_default_table']}
            set de_admin_company_owner        = '$de_admin_company_owner',
                ...
                de_contents_layout_use        = '$de_contents_layout_use',
                de_contents_skin              = '$de_contents_skin',
                de_contents_mobile_skin       = '$de_contents_mobile_skin',
                ...
                de_cash_use                   = '$de_cash_use',
                de_cash_charge_use            = '$de_cash_charge_use',
                de_cash_charge_price          = '$de_cash_charge_price',
