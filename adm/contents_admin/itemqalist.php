...
$sql_common = "  from {$g5['g5_contents_item_qa_table']} a
                 left join {$g5['g5_contents_item_table']} b on (a.it_id = b.it_id)
...
<form name="fitemqalist" method="post" action="./itemqalistupdate.php" onsubmit="return fitemqalist_submit(this);" autocomplete="off" id="itqa_li">
...
<div class="tbl_head01 tbl_wrap">
    ...
    <tr class="<?php echo $bg; ?>">
        ...
        <td class="td_prd"><a href="<?php echo $href; ?>"><?php echo cm_get_it_image($row['it_id'], 50, 50); ?> <?php echo cut_str($row['it_name'],30); ?></a></td>
        <td>
