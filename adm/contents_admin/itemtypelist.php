...
<div class="tbl_head01 tbl_wrap">
    ...
    <tr>
        ...
        <th scope="col"><?php echo subject_sort_link("it_type4", $qstr, 1); ?>할인<br>상품</a></th>
        <th scope="col">관리</th>
    </tr>
    </thead>
    <tbody>
    ...
    <tr class="<?php echo $bg; ?>">
        ...
        <td class="td_chk">
            <label for="type1_<?php echo $i; ?>" class="sound_only">추천상품</label>
            <input type="checkbox" name="it_type1[<?php echo $i; ?>]" value="1" id="type1_<?php echo $i; ?>" <?php echo ($row['it_type1'] ? 'checked' : ''); ?>>
        </td>
        <td class="td_chk">
            <label for="type2_<?php echo $i; ?>" class="sound_only">인기상품</label>
        ...
        <td class="td_chk">
            <label for="type4_<?php echo $i; ?>" class="sound_only">할인상품</label>
