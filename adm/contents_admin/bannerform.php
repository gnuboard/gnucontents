...
{
    $html_title .= ' 수정';
    $sql = " select * from {$g5['g5_contents_banner_table']} where bn_id = '$bn_id' ";
    $bn = sql_fetch($sql);
}
else
{
...
<div class="tbl_frm01 tbl_wrap">
    ...
    <tr>
        ...
        <td>
            ...
            <?php
            $bimg_str = "";
            $bimg = G5_DATA_PATH."/cmbanner/{$bn['bn_id']}";
            if (file_exists($bimg) && $bn['bn_id']) {
                ...
                $bimg_str = '<img src="'.G5_DATA_URL.'/cmbanner/'.$bn['bn_id'].'" width="'.$width.'">';
                //$size = getimagesize($bimg);
