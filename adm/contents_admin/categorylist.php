...
<div id="sct" class="tbl_head02 tbl_wrap">
    ...
    for ($i=0; $row=sql_fetch_array($result); $i++)
    {
        ...
        if ($level > 0) {
            ...
            $sql = " select ca_name from {$g5['g5_contents_category_table']} where ca_id = '$p_ca_id' ";
            $temp = sql_fetch($sql);
        ...
        // 해당 분류에 속한 상품의 수
        $sql1 = " select COUNT(*) as cnt from {$g5['g5_contents_item_table']}
    ...
    <tr class="<?php echo $bg; ?>">
        <td class="td_code" rowspan="2">
            ...
            <a href="<?php echo G5_CONTENTS_URL; ?>/list.php?ca_id=<?php echo $row['ca_id']; ?>"><?php echo $row['ca_id']; ?></a>
        </td>
