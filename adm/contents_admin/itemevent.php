...
$sql_common = " from {$g5['g5_contents_event_table']} ";
...
<div class="tbl_head01 tbl_wrap">
    ...
    for ($i=0; $row=mysql_fetch_array($result); $i++) {
        ...
        $href = "";
        $sql = " select count(ev_id) as cnt from {$g5['g5_contents_event_item_table']} where ev_id = '{$row['ev_id']}' ";
        $ev = sql_fetch($sql);
        if ($ev['cnt']) {
    ...
    <tr>
        ...
        <td class="td_mng">
            ...
            <a href="<?php echo G5_CONTENTS_URL; ?>/event.php?ev_id=<?php echo $row['ev_id']; ?>">보기</a>
