...
<div class="tbl_head01 tbl_wrap sale1">
    ...
    <tr>
        ...
        <td class="td_r"><?php echo number_format($tot['ordercoupon']); ?></td>
        <td class="td_r"><?php echo number_format($tot['receiptbank']); ?></td>
        <td class="td_r"><?php echo number_format($tot['receiptvbank']); ?></td>
        <td class="td_r"><?php echo number_format($tot['receiptiche']); ?></td>
        <td class="td_r"><?php echo number_format($tot['receiptcard']); ?></td>
        <td class="td_r"><?php echo number_format($tot['receipthp']); ?></td>
        <td class="td_r"><?php echo number_format($tot['receiptcash']); ?></td>
        <td class="td_r"><?php echo number_format($tot['receiptpoint']); ?></td>
