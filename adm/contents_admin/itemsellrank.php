...
$sql  = " select a.it_id,
                 ...
                 SUM(IF(ct_status = '완료',ct_qty, 0)) as ct_status_4,
                 SUM(IF(ct_status = '취소',ct_qty, 0)) as ct_status_5,
                 SUM(IF(ct_status = '품절',ct_qty, 0)) as ct_status_6,
                 SUM(ct_qty) as ct_status_sum
            from {$g5['g5_contents_cart_table']} a, {$g5['g5_contents_item_table']} b ";
...
<select name="sel_ca_id" id="sel_ca_id">
    ...
    <?php
    $sql1 = " select ca_id, ca_name from {$g5['g5_contents_category_table']} order by ca_order, ca_id ";
...
<div class="tbl_head01 tbl_wrap"  id="itemuserank">
    <table>
    ...
    <tr>
        <th scope="col">순위</th>
        <th scope="col">상품명</th>
        <th scope="col"><a href="<?php echo cm_title_sort("ct_status_1",1)."&amp;$qstr1"; ?>">쇼핑</a></th>
        <th scope="col"><a href="<?php echo cm_title_sort("ct_status_2",1)."&amp;$qstr1"; ?>">주문</a></th>
        <th scope="col"><a href="<?php echo cm_title_sort("ct_status_3",1)."&amp;$qstr1"; ?>">입금</a></th>
        <th scope="col"><a href="<?php echo cm_title_sort("ct_status_6",1)."&amp;$qstr1"; ?>">완료</a></th>
        <th scope="col"><a href="<?php echo cm_title_sort("ct_status_7",1)."&amp;$qstr1"; ?>">취소</a></th>
        <th scope="col"><a href="<?php echo cm_title_sort("ct_status_9",1)."&amp;$qstr1"; ?>">품절</a></th>
        <th scope="col"><a href="<?php echo cm_title_sort("ct_status_sum",1)."&amp;$qstr1"; ?>">합계</a></th>
    </tr>
    </thead>
    <tbody>
    <?php
    ...
    {
        $href = G5_CONTENTS_URL."/item.php?it_id={$row['it_id']}";
        ...
        <tr class="<?php echo $bg; ?>">
            <td class="td_num td_c"><?php echo $num; ?></td>
            <td><a href="<?php echo $href; ?>"><?php echo cm_get_it_image($row['it_id'], 50, 50); ?> <?php echo cut_str($row['it_name'],30); ?></a></td>
