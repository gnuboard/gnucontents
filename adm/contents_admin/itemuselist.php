...
$sql_common = "  from {$g5['g5_contents_item_use_table']} a
...
<form name="fitemuselist" method="post" action="./itemuselistupdate.php" onsubmit="return fitemuselist_submit(this);" autocomplete="off" id="ituse_li">
