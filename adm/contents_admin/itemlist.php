...
$sql_common = " from {$g5['g5_contents_item_table']} a ,
                     {$g5['g5_contents_category_table']} b
...
<div class="tbl_head02 tbl_wrap">
    ...
    <tr class="<?php echo $bg; ?>">
        ...
        <td colspan="4">
            ...
            <select name="ca_id[<?php echo $i; ?>]" id="ca_id_<?php echo $i; ?>">
                <?php echo cm_conv_selected_option($ca_list, $row['ca_id']); ?>
            </select>
            ...
            <select name="ca_id2[<?php echo $i; ?>]" id="ca_id2_<?php echo $i; ?>">
                <?php echo cm_conv_selected_option($ca_list, $row['ca_id2']); ?>
            </select>
            ...
            <select name="ca_id3[<?php echo $i; ?>]" id="ca_id3_<?php echo $i; ?>">
                <?php echo cm_conv_selected_option($ca_list, $row['ca_id3']); ?>
            </select>
        </td>
        ...
        <td rowspan="3" class="td_num td_c"><?php echo $row['it_hit']; ?></td>
    ...
    <tr class="<?php echo $bg; ?>">
        <td rowspan="2" class="td_img"><a href="<?php echo $href; ?>"><?php echo cm_get_it_image($row['it_id'], 50, 50); ?></a></td>
        ...
        <td headers="th_skin" class="td_numbig td_input">
            ...
            <select name="it_skin[<?php echo $i; ?>]" id="it_skin_<?php echo $i; ?>">
                <?php echo cm_conv_selected_option($skin_list, $row['it_skin']); ?>
            </select>
        </td>
    </tr>
    <tr class="<?php echo $bg; ?>">
        ...
        <td headers="th_mskin" class="td_numbig td_input">
            ...
            <select name="it_mobile_skin[<?php echo $i; ?>]" id="it_mobile_skin_<?php echo $i; ?>">
                <?php echo cm_conv_selected_option($mskin_list, $row['it_mobile_skin']); ?>
            </select>
        </td>
    </tr>
    <?php
