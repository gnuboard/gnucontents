...
$type = $_POST['type'];
$arr_type = array('board', 'conf_skin', 'conf_member', 'contents_skin', 'contents_pc_index', 'contents_mobile_index', 'contents_etc', 'contents_event', 'contents_category');
...
if($type == 'board') {
...
} else if($type == 'contents_skin') {
    $keys = array('de_contents_skin', 'de_contents_mobile_skin');
...
} else if($type == 'contents_pc_index') {
    $keys = array();
    for($i=1; $i<=4; $i++) {
...
} else if($type == 'contents_mobile_index') {
    $keys = array();
    for($i=1; $i<=4; $i++) {
    ...
    if($i == 0)
        $data['error'] = '적용할 테마 설정이 없습니다.';
} else if($type == 'contents_etc') {
    $keys = array('de_movie_skin', 'de_rel_list_use', 'de_rel_list_skin', 'de_rel_list_mod', 'de_rel_img_width', 'de_rel_img_height', 'de_mobile_rel_list_use', 'de_mobile_rel_list_skin', 'de_mobile_rel_list_mod', 'de_mobile_rel_img_width', 'de_mobile_rel_img_height', 'de_search_list_skin', 'de_search_list_mod', 'de_search_list_row', 'de_search_img_width', 'de_search_img_height', 'de_mobile_search_list_skin', 'de_mobile_search_list_mod', 'de_mobile_search_list_row', 'de_mobile_search_img_width', 'de_mobile_search_img_height', 'de_mimg_width', 'de_mimg_height');
    ...
    if($i == 0)
        $data['error'] = '적용할 테마 설정이 없습니다.';
} else if($type == 'contents_category') {
